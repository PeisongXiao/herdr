...
fn api_method_name(method: &Method) -> &'static str {
    match method {
        ...
        Method::TerminalDelegatePark(_) => "terminal.delegate.park",
        Method::TerminalParkedStatus(_) => "terminal.delegate.parked.status",
        Method::TerminalParkedResume(_) => "terminal.delegate.parked.resume",
        Method::TerminalParkedList(_) => "terminal.delegate.parked.list",
        Method::TerminalParkedResolve(_) => "terminal.delegate.parked.resolve",
        Method::TerminalParkedAdminList(_) => "terminal.delegate.parked.admin.list",
        Method::TerminalParkedAdminResolve(_) => "terminal.delegate.parked.admin.resolve",
        Method::TerminalRecoveryList(_) => "terminal.recovery.list",
        Method::TerminalRecoveryStatus(_) => "terminal.recovery.status",
        Method::TerminalRecoveryRetry(_) => "terminal.recovery.retry",
        Method::TerminalRecoveryDiscard(_) => "terminal.recovery.discard",
